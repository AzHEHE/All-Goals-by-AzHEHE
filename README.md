...
**Current release: V1 (mod version 1.0.2) — for Minecraft Java Edition 26.1.1**
...
The current goal pool is **All Goals V1**, released as mod version **1.0.2**. Because later versions may add, remove, or adjust goals as Draftout changes, completed runs should always state which All Goals version was used.
